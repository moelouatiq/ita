...
const values = [
  { icon: '🎯', title: 'Rigueur', description: 'Chaque livrable est testé, validé et documenté. Nous ne livrons que ce dont nous sommes fiers.' },
  { icon: '🤝', title: 'Proximité', description: 'Vous avez un interlocuteur dédié, disponible et qui connaît votre projet sur le bout des doigts.' },
  { icon: '💡', title: 'Innovation', description: 'Nous suivons les évolutions du web pour vous proposer des solutions modernes et pérennes.' },
  { icon: '🌿', title: 'Transparence', description: 'Prix affichés, délais tenus, pas de surprises. Une relation client basée sur la confiance.' },
]
...
const stats = [
  { target: 6, suffix: '+', label: "Ans d'exp." },
  { target: 150, suffix: '+', label: 'Projets' },
    ...
    <>
      ...
      <section className="relative hero-gradient noise overflow-hidden pt-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          ...
          <ScrollReveal delay={0.15}>
            <h1 className="font-title text-4xl md:text-5xl font-bold text-white leading-tight mb-6 max-w-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <ScrollReveal direction="right">
              ...
              <div className="grid grid-cols-3 gap-6 mt-10">
                {stats.map((s) => (
                  <div key={s.label} className="text-center p-4 bg-orange-50 rounded-2xl">
                    <p className="font-title font-bold text-3xl text-accent">
      ...
      <section className="section-padding bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="text-center mb-14">
            ...
            <h2 className="font-title text-3xl md:text-4xl font-bold text-primary mt-4">Ce qui nous définit</h2>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {team.map((member, i) => (
              <ScrollReveal key={member.name} delay={i * 0.12}>
                <div className="card card-tilt glow-hover text-center">
                  <div className={`w-20 h-20 rounded-full bg-gradient-to-br ${member.color} flex items-center justify-center text-white font-title font-bold text-2xl mx-auto mb-5 shadow-lg`}>
                    {member.initial}
                  </div>
      ...
      <section className="section-padding bg-primary relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            <span className="inline-block bg-orange-900/50 text-accent text-sm font-semibold px-4 py-1.5 rounded-full">Notre approche client</span>
            <h2 className="font-title text-3xl font-bold text-white mt-4 mb-6">Votre succès est notre portfolio</h2>
            ...
            <Link href="/contact" className="btn-primary btn-pulse text-base py-4 px-8 inline-flex">
              Démarrer un projet
            </Link>
          </ScrollReveal>
        </div>
